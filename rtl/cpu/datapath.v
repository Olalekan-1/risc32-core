module datapath(input clk, reset, reg_write_en, mem_write_en, pc_src, reg_src_a, reg_src_b, mem_to_reg, alu_src, pc_en,
    ...
    pc pc_flops(.clk(clk), .reset(reset), .data(pc_next), .q(pc), .en(pc_en));
